#!/usr/bin/env python3
"""Aggregate a wvc Terminal-Bench Harbor job dir and compare against the
...
def main() -> int:
    ...
    print(f"{'task':38} {'base%':>7} {'wvc%':>7} {'pass':>6} {'flag'}")
    print("-" * 75)
    ...
    print("-" * 75)
    if wvc_trials:
        print(f"wvc micro-avg: {wvc_resolved}/{wvc_trials} = {100*wvc_resolved/wvc_trials:.1f}%")
