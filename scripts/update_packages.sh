...
LINUX_URL="https://github.com/nicolasramos/weavecoder/releases/download/${VERSION}/wvc-linux-x86_64.tar.gz"
LINUX_ARM_URL="https://github.com/nicolasramos/weavecoder/releases/download/${VERSION}/wvc-linux-aarch64.tar.gz"
MACOS_ARM_URL="https://github.com/nicolasramos/weavecoder/releases/download/${VERSION}/wvc-macos-aarch64.tar.gz"
MACOS_INTEL_URL="https://github.com/nicolasramos/weavecoder/releases/download/${VERSION}/wvc-macos-x86_64.tar.gz"
...
git clone --depth 1 git@github.com:1jehuang/homebrew-wvc.git "$BREW_DIR" 2>/dev/null

cat > "$BREW_DIR/Formula/wvc.rb" <<EOF
class Weavecoder < Formula
  desc "AI coding agent powered by Claude and ChatGPT"
  homepage "https://github.com/nicolasramos/weavecoder"
  version "$VERSION_NUM"
  license "MIT"
...
arch=('x86_64')
url="https://github.com/nicolasramos/weavecoder"
license=('MIT')
provides=('wvc')
conflicts=('wvc')
source=("$LINUX_URL")
