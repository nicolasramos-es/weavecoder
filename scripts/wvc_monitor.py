#!/usr/bin/env python3
"""
wvc Live Monitor - Real-time activity dashboard

Connects to wvc's debug socket and displays live streaming events.
Run wvc serve in one terminal, then this monitor in another.

Usage: ./wvc_monitor.py [--socket PATH]
"""
