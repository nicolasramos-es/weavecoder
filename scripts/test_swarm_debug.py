...
SOCKET_PATH = f"/run/user/{os.getuid()}/wvc-debug.sock"
MAIN_SOCKET_PATH = f"/run/user/{os.getuid()}/wvc.sock"
...
def main():
    ...
    if not os.path.exists(SOCKET_PATH):
        ...
        print("Make sure wvc server is running with debug control enabled.")
