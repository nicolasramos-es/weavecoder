...
try {
    ...
    Invoke-Case 'release_lookup_avoids_unauthenticated_github_api' {
        Assert-Equal 'v1.2.3' (Resolve-WeavecoderReleaseTagFromUri 'https://github.com/nicolasramos-es/weavecoder/releases/tag/v1.2.3') 'release redirect parser should extract the stable tag'
        Assert-Equal 'v1.2.3-rc.1' (Resolve-WeavecoderReleaseTagFromUri 'https://github.com/nicolasramos-es/weavecoder/releases/tag/v1.2.3-rc.1?source=latest') 'release redirect parser should stop before query parameters'
