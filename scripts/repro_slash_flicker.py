#!/usr/bin/env python3
"""
Reproduce the "slash command menu flickers in a freshly spawned wvc" bug.
...
def main() -> int:
    ...
    root = Path(tempfile.mkdtemp(prefix="wvc-slash-flicker-"))
    ...
    if not args.json:
        print("== wvc slash-menu flicker repro ==")
