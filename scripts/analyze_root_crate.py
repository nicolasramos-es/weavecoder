#!/usr/bin/env python3
"""Analyze the monolithic root `wvc` crate to plan a bottom-up split.
...
computes:
  ...
  - facade: whether it is already just `pub use wvc_*::*;`
...
FACADE_RE = re.compile(r"pub use wvc_[a-z0-9_]+::")
