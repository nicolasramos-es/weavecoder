//! Client-server protocol for wvc
//!
...
pub type ReloadRecoverySnapshot = wvc_selfdev_types::ReloadRecoveryDirective;
...
impl PlanGraphStatus {
    ...
    pub fn from_versioned_plan(
        ...
        let growth = wvc_plan::bridge::growth_stats(plan);
        ...
        Self {
            ...
            newly_ready_ids,
            low_confidence_ids: wvc_plan::bridge::low_confidence_completed_ids(plan),
