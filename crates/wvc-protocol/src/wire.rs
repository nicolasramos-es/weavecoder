...
/// Mirrors `wvc_plan::dag::NodeSpec` but kept as an explicit wire type so the
...
pub enum Request {
    ...
    Reload {
        ...
        /// `wvc server reload` can request a graceful upgrade without risking
    ...
    SetCompactionMode {
        id: u64,
        mode: wvc_config_types::CompactionMode,
    },
    ...
    /// Query wvc agent's capabilities
...
pub enum ServerEvent {
    ...
    History {
        ...
        #[serde(default, skip_serializing_if = "Vec::is_empty")]
        available_model_routes: Vec<wvc_provider_core::ModelRoute>,
        ...
        #[serde(default, skip_serializing_if = "Option::is_none")]
        resolved_credential: Option<wvc_provider_core::ResolvedCredential>,
        ...
        #[serde(default)]
        compaction_mode: wvc_config_types::CompactionMode,
    ...
    CommListModelsResponse {
        ...
        #[serde(default, skip_serializing_if = "Vec::is_empty")]
        model_routes: Vec<wvc_provider_core::ModelRoute>,
    },
