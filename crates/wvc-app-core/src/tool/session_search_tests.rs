...
#[test]
fn external_codex_sessions_are_searchable_without_wvc_session_dir() {
    with_temp_home(|home| {
        ...
        assert_eq!(report.scanned_wvc_sessions, 0);
...
#[test]
fn external_cursor_sessions_are_searchable_without_wvc_session_dir() {
    with_temp_home(|home| {
