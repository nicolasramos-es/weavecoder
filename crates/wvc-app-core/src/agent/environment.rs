use super::{Agent, WVC_REPO_SOURCE_STATE, WORKING_GIT_STATE_CACHE};
use crate::logging;
...
impl Agent {
    ...
    pub(super) fn build_env_snapshot(
        ...
        let (wvc_git_hash, wvc_git_dirty) = match detail {
            EnvSnapshotDetail::Full => WVC_REPO_SOURCE_STATE.clone(),
        ...
        EnvSnapshot {
            ...
            wvc_version: wvc_build_meta::version().to_string(),
            wvc_git_hash,
            wvc_git_dirty,
