...
impl Agent {
    ...
    pub fn model_catalog_snapshot(&self) -> wvc_provider_core::ModelCatalogSnapshot {
    ...
    pub fn active_resolved_credential(&self) -> Option<wvc_provider_core::ResolvedCredential> {
