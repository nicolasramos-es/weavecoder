...
fn resolve_builds_dir(
    wvc_home: Option<PathBuf>,
    local_app_data: Option<PathBuf>,
    default_wvc_dir: PathBuf,
    is_windows: bool,
) -> PathBuf {
    if let Some(wvc_home) = wvc_home {
        return wvc_home.join("builds");
    }
...
mod tests {
    ...
    #[test]
    fn non_windows_builds_stay_under_wvc_home() {
        let resolved = resolve_builds_dir(
            None,
