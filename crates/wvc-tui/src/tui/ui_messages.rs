...
fn render_compact_agent_notification(
    ...
    let collapsible = wvc_tui_messages::parse_collapsible_swarm_content(content);
...
pub(crate) fn render_swarm_message(
    ...
    let collapsible = wvc_tui_messages::parse_collapsible_swarm_content(&msg.content);
    ...
    match action {
        "suggest" => {
            ...
            push_compact_discovery_kv(
                &mut content,
                "review",
                "Weavecoder maintainers only; not approval or availability",
                block_width,
                label_style,
                muted_style,
                MAX_DISCOVERY_DETAIL_LINES,
