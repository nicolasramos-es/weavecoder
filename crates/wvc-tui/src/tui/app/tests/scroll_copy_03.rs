...
fn test_click_on_swarm_expand_badge_toggles_tldr_collapse() {
    ...
    let content = wvc_tui_messages::encode_collapsible_swarm_content("fixed the flaky test", body);
    app.display_messages = vec![
    ...
    assert!(
        wvc_tui_messages::parse_collapsible_swarm_content(&app.display_messages[1].content)
