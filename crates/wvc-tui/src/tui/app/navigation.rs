...
impl App {
    ...
    pub(super) fn toggle_swarm_message_expand(&mut self, msg_idx: usize) -> bool {
        ...
        let Some(toggled) = wvc_tui_messages::toggle_collapsible_swarm_content(&message.content)
        else {
            return false;
        };
        let expanded = wvc_tui_messages::parse_collapsible_swarm_content(&toggled)
    ...
    pub(super) fn toggle_inline_images(&mut self) {
        ...
        self.set_status_notice(if self.inline_images_visible {
            ...
            let alt = wvc_tui_core::keybind::alt_chord("Shift+I");
