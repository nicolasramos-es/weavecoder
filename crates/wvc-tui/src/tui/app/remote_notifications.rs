    ...
    } = notification_type
    {
        ...
        if !tldr.is_empty() && !presentation.message.trim().is_empty() {
            ...
            presentation.message =
                wvc_tui_messages::encode_collapsible_swarm_content(tldr, &presentation.message);
        }
    }
    presentation
}
...
mod tests {
    ...
    fn present_swarm_notification_with_tldr_encodes_collapsed_content() {
        ...
        let parsed = wvc_tui_messages::parse_collapsible_swarm_content(&presentation.message)
