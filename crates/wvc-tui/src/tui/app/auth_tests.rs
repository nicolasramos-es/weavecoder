...
#[test]
fn tui_openai_compatible_api_base_keeps_wvc_docs_and_remote_endpoint() -> anyhow::Result<()> {
    with_temp_wvc_home(|| {
        ...
        assert!(resolved.requires_api_key);
        assert!(resolved.setup_url.contains("github.com/nicolasramos-es/weavecoder"));
