...
pub(super) use wvc_tui_messages::{centered_wrap_width, left_pad_lines_for_centered_mode};
...
{
    wvc_tui_messages::get_cached_message_lines(
        msg,
        width,
        diff_mode,
        wvc_tui_messages::MessageCacheContext {
