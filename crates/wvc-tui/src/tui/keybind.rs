...
pub use wvc_config_types::keybindings::{
...
pub(crate) fn side_panel_toggle_key_label() -> String {
    wvc_tui_core::keybind::alt_chord("M")
}
...
/// Optional binding that spawns a fresh wvc session in a new terminal window.
