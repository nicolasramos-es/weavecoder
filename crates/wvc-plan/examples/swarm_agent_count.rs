...
//!
//! This drives the *real* task-DAG engine (`wvc_plan::dag`) with scripted mock
...
//!
//! Run with: `cargo run -p wvc-plan --example swarm_agent_count`
//!
...
use wvc_plan::dag::sim::deep_artifact;
use wvc_plan::dag::{
