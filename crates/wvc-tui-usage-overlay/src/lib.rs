...
impl UsageOverlay {
    ...
    pub fn from_progress(progress: &wvc_usage_types::ProviderUsageProgress) -> Self {
    ...
    pub fn from_provider_reports(
        reports: &[wvc_usage_types::ProviderUsage],
        refreshing: bool,
        completed: usize,
        total: usize,
        from_cache: bool,
...
fn provider_item(report: &wvc_usage_types::ProviderUsage) -> UsageOverlayItem {
...
fn provider_status(report: &wvc_usage_types::ProviderUsage) -> UsageOverlayStatus {
...
fn provider_subtitle(report: &wvc_usage_types::ProviderUsage) -> String {
...
fn provider_detail_lines(report: &wvc_usage_types::ProviderUsage) -> Vec<String> {
...
mod tests {
    ...
    fn provider_reports_build_searchable_overlay_items() {
        let overlay = UsageOverlay::from_provider_reports(
            &[wvc_usage_types::ProviderUsage {
                provider_name: "Claude".to_string(),
                limits: vec![wvc_usage_types::UsageLimit {
                    name: "5h".to_string(),
                    usage_percent: 92.0,
