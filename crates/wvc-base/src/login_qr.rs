...
fn qr_rendering_enabled() -> bool {
    env_truthy("WVC_SHOW_LOGIN_QR") || env_truthy("WVC_LOGIN_QR")
}

fn tui_qr_rendering_enabled() -> bool {
    env_truthy("WVC_SHOW_TUI_LOGIN_QR") || env_truthy("WVC_TUI_LOGIN_QR")
}
...
mod tests {
    ...
    fn markdown_section_wraps_qr_in_code_block() {
        ...
        crate::env::set_var("WVC_SHOW_LOGIN_QR", "1");
        let section =
        ...
        crate::env::remove_var("WVC_SHOW_LOGIN_QR");
    }
    ...
    fn tui_markdown_section_is_opt_in_even_when_general_qr_is_enabled() {
        let _guard = lock_test_env();
        crate::env::set_var("WVC_SHOW_LOGIN_QR", "1");
        crate::env::remove_var("WVC_SHOW_TUI_LOGIN_QR");
        crate::env::remove_var("WVC_TUI_LOGIN_QR");
    ...
    fn tui_markdown_section_uses_dedicated_env_flag() {
        let _guard = lock_test_env();
        crate::env::set_var("WVC_SHOW_TUI_LOGIN_QR", "1");
    ...
    fn qr_sections_are_disabled_by_default() {
        let _guard = lock_test_env();
        crate::env::remove_var("WVC_SHOW_LOGIN_QR");
        crate::env::remove_var("WVC_LOGIN_QR");
