...
impl BackgroundTaskManager {
    ...
    fn publish_task_started_activity(
        ...
        Bus::global().publish(BusEvent::UiActivity(crate::bus::UiActivity::background(
            ...
            format!(
                "**Background task started** `{}` · `{}`\n\nWeavecoder is running this in the background. Progress, checkpoints, and completion will appear here.",
                task_id, safe_label
            ),
    ...
    /// every wvc process on the machine:
    ...
    pub async fn adopt(
        ...
        tool_name: &str,
        session_id: &str,
        handle: JoinHandle<Result<wvc_tool_types::ToolOutput>>,
    ) -> BackgroundTaskInfo {
