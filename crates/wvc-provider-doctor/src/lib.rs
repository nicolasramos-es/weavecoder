//! Provider-doctor diagnostics for wvc.
//!
//! Sits downstream of `wvc-base` so edits to the doctor cluster do not
//! rebuild the base -> app-core -> tui spine:
//! - [`provider_e2e`]: the strict end-to-end runner behind `wvc
