...
mod tests {
    ...
    fn loads_api_key_from_env_before_config_file() {
        ...
        wvc_core::env::set_var("JCODE_PROVIDER_ENV_TEST_KEY", "env-key");
    ...
    fn loads_and_removes_values_from_sandboxed_config_file() {
        ...
        wvc_core::env::remove_var("JCODE_PROVIDER_ENV_TEST_VALUE");
        assert_eq!(
    ...
    fn loads_api_key_with_invisible_chars_from_env_var() {
        ...
        wvc_core::env::set_var("JCODE_PROVIDER_BAR_API_KEY", "\u{00A0}sk-env-key\u{FEFF}");
