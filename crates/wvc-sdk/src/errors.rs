...
pub enum ErrorKind {
    ...
    Harness(wvc_harness_api::ErrorCode),
    ...
    pub fn code(&self) -> &'static str {
        match self {
            ...
            Self::Harness(code) => match code {
                wvc_harness_api::ErrorCode::UnsupportedVersion => "unsupported_version",
                wvc_harness_api::ErrorCode::UnknownRequest => "unknown_request",
                wvc_harness_api::ErrorCode::UnknownSession => "unknown_session",
                wvc_harness_api::ErrorCode::InvalidRequest => "invalid_request",
                wvc_harness_api::ErrorCode::Internal => "internal",
            },
        }
    }
}
...
impl From<wvc_harness_api::FrameError> for Error {
    fn from(error: wvc_harness_api::FrameError) -> Self {
        let kind = match error {
            wvc_harness_api::FrameError::Eof => ErrorKind::Disconnected,
