//! Rust SDK for the wvc harness.
//!
//! The API crate (`wvc-harness-api`) defines the wire protocol. This crate
...
//!
//! ```no_run
//! use wvc_sdk::{ConnectOptions, WeavecoderClient, RunOptions};
//!
//! let client = WeavecoderClient::connect(ConnectOptions::default())?;
...
pub use launch::{
    ...
    socket_accepts, user_app_config_dir, user_wvc_home, wait_for_socket,
};
pub use structured::{
...
pub use wvc_harness_api as api;
pub use wvc_harness_api::{
