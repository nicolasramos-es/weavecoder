...
pub(super) async fn login_wvc_device_flow(no_browser: bool) -> Result<LoginCompletion> {
    ...
    crate::telemetry::record_auth_success("wvc-subscription", "device_code_browser");
    Ok(completion)
}
