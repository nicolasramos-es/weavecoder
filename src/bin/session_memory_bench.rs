...
use weavecoder::message::{ContentBlock, Role};
use weavecoder::process_memory;
...
fn main() -> anyhow::Result<()> {
    ...
    let display_messages = weavecoder::tui::display_messages_from_session(&session);
    ...
    let client_memory = weavecoder::tui::transcript_memory_profile(
        &session,
